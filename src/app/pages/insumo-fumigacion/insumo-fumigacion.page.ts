...
import { InsumoFumigacionService } from '../../services/insumo-fumigacion.service';

@Component({
  selector: 'app-insumo-fumigacion',
  templateUrl: './insumo-fumigacion.page.html',
  styleUrls: ['./insumo-fumigacion.page.scss'],
})
export class InsumoFumigacionPage implements OnInit {
 ...
 constructor(
   ...
   private insumoFumigacionService: InsumoFumigacionService,
 ...
 viewInsumoFumigacion(id: string, nombre: string, marca: string, idpresentacion: string, idresponsable: string) {
   ...
   this.router.navigate(['insumo-fumigacion-detail'], data);
 }
