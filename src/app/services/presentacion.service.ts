...
export class PresentacionService {
  ...
  getPresentacion() {
    return this.http.get<ModelPresentacion>(
      this.baseUrl + 'Controller/Presentacion/CtlPresentacion.php?action=list'
    );
  }

   /*Funcion que se encarga de registrar al rol, recibiendo por parametro
  los datos del rol*/
  savePresentacionDataService(postData: any) {
    /*URL del web service*/
    const url = this.baseUrl + "Controller/Presentacion/CtlPresentacion.php";
  ...
  el id*/
  deletePresentacionDataService(postData: any) {
    /*URL del web service*/
    const url = this.baseUrl + "Controller/Presentacion/CtlPresentacion.php";
    /*Se muestra una barra de carga*/
    this.helperService.mostrarBarraDeCarga(this.translate.instant("espere"));
