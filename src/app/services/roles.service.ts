...
export class RolesService {
  ...
  getRoles() {
    return this.http.get<ModelRol>(
      'http://localhost/MacapaAppBackend/Controller/Configuration/CtlRol.php?action=list'
    );
  }
  ...
  saveRolDataService( postData: any) {
    ...
    /*URL del web service*/
    const url = 'http://localhost/MacapaAppBackend/Controller/Configuration/CtlRol.php';
