...
export class PlanDeManejoService {
  ...
  getPlanDeManejo() {
    return this.http.get<ModelPlanDeManejo>(
      this.baseUrl + 'Controller/Plandemanejo/CtlPlandemanejo.php?action=list'
    );
  }
  
  /*Funcion que se encarga de registrar al rol, recibiendo por parametro
  los datos del rol*/
  savePlanDeManejoDataService(postData: any) {
    /*URL del web service*/
    const url = this.baseUrl + "Controller/Plandemanejo/CtlPlandemanejo.php";
  ...
  el id*/
  deletePlanDeManejoDataService(postData: any) {
    /*URL del web service*/
    const url = this.baseUrl + "Controller/Plandemanejo/CtlPlandemanejo.php";
    /*Se muestra una barra de carga*/
    this.helperService.mostrarBarraDeCarga(this.translate.instant("espere"));
